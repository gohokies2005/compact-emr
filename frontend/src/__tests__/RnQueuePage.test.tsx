...
describe('RnQueuePage', () => {
  ...
  // REMOVED (C7 lifecycle, 2026-06-13): the "Confirm pack pages" doc-selection-review tab tests —
  // the tab, its API client (listKeyDocsNeedingReview / acknowledgeKeyDoc), and the backend
  // endpoints were deleted as vestigial. The manual-summary + enrichment tests around them stay.
