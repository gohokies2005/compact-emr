...
def assemble_pack(
    ...
    entry #0 (merged first). Returns {entry_start_page, skipped_non_pdf}.
    ...
    if cover_link_map:
        try:
            _stamp_cover_links_and_outline(writer, cover_link_map, entry_start_page)
    ...
    return {"entry_start_page": entry_start_page, "skipped_non_pdf": skipped_non_pdf}
