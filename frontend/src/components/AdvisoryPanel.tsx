  ...
  return (
    <div className="space-y-4">
      <Card className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        <h2 className="text-base font-semibold text-slate-900">Ask AI about this case</h2>
      ...
      {answer ? (
        <Card className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-4 border-t border-slate-100 pt-2 text-[11px] text-slate-400">
            Generated by AI (Claude) for decision support · verify before use · ~${answer.costUsd.toFixed(2)}
          </p>
        </Card>
      ) : null}
    </div>
