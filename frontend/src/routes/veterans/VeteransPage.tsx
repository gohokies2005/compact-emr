...
export function VeteransPage() {
  ...
  return <AppShell><div className="space-y-6">
    ...
    <input aria-label="Search veterans" className="w-full rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm outline-none focus:border-indigo-500" placeholder="Search veterans by name, email, or ID…" value={q} onChange={(e) => setQ(e.target.value)} />
