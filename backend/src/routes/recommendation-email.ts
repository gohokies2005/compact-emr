...
function parseBridge(v: unknown): OutreachBridge | null {
  ...
  return {
    intermediate_dx: b['intermediate_dx'],
    claimed: b['claimed'],
    intermediate_presumptive_basis: typeof b['intermediate_presumptive_basis'] === 'string' ? b['intermediate_presumptive_basis'] : '',
  };
}
  ...
  router.post(
    ...
    asyncHandler(async (req: Request, res: Response) => {
      ...
      const result = await draftOutreachEmail({
        ...
        missingFact: typeof body['missingFact'] === 'string' ? body['missingFact'] : null,
