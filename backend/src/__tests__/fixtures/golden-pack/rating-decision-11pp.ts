/**
 * Golden-pack fixture (assessment 2026-06-12 §1): an 11-page VA rating decision replicating
 * the LIVE failure shape. Pages 1-2 are the real payload (decision table + REASONS FOR
 * DECISION). Pages 3-11 are the VA enclosure boilerplate that "sailed in" on the first live
 * pack because every enclosure page says "service-connected" and "granted" — exactly like the
 * real letters do. Synthetic text, no PHI.
 */
