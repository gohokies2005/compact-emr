...
describe('parseSecondaryFraming — the secondary anchor the veteran stated', () => {
  const cases: Array<[string, string]> = [
    ...
    ['I believe my GERD is caused or aggravated by my service-connected lumbar spine condition', 'lumbar spine'],
    ['Second time getting denied secondary to major depression and anxiety', 'major depression'],
