...
// Values below are derived from the curated bva_secondary_pairs.json (n/win_pct/imo_*), recomputed
// 2026-06-07 when the strategy engine was repointed onto the canonical curated atlas. Every oddsExact
// + verdict is the engine's actual output for that pair.
const realBoundaries: readonly ThresholdCase[] = [
  // Top-of-distribution (IMO usable, accept tier)
  { up: 'PTSD', cl: 'Erectile dysfunction', oddsExact: 100, tier: 'high', expectedVerdict: 'accept' },
  { up: 'Lumbar / back', cl: 'GERD', oddsExact: 100, tier: 'moderate', expectedVerdict: 'accept' },
  { up: 'Knee', cl: 'GERD', oddsExact: 100, tier: 'moderate', expectedVerdict: 'accept' },
  { up: 'Tinnitus', cl: 'Migraines / headaches', oddsExact: 96.9, tier: 'high', expectedVerdict: 'accept' },
  { up: 'PTSD', cl: 'GERD', oddsExact: 94.1, tier: 'high', expectedVerdict: 'accept' },
  { up: 'PTSD', cl: 'Migraines / headaches', oddsExact: 93.9, tier: 'high', expectedVerdict: 'accept' },
  { up: 'MDD / Depression', cl: 'Migraines / headaches', oddsExact: 93.3, tier: 'moderate', expectedVerdict: 'accept' },
  { up: 'Plantar fasciitis / foot', cl: 'Lumbar / back', oddsExact: 90.3, tier: 'high', expectedVerdict: 'accept' },
  { up: 'Obesity', cl: 'Obstructive sleep apnea', oddsExact: 88, tier: 'high', expectedVerdict: 'accept' },
  { up: 'MDD / Depression', cl: 'Obstructive sleep apnea', oddsExact: 88, tier: 'high', expectedVerdict: 'accept' },
  { up: 'Sinusitis / rhinitis', cl: 'Obstructive sleep apnea', oddsExact: 86.8, tier: 'high', expectedVerdict: 'accept' },
  { up: 'Cervical / neck', cl: 'Obstructive sleep apnea', oddsExact: 85.7, tier: 'moderate', expectedVerdict: 'accept' },
  { up: 'Knee', cl: 'Obstructive sleep apnea', oddsExact: 84.6, tier: 'high', expectedVerdict: 'accept' },
  { up: 'Lumbar / back', cl: 'Obstructive sleep apnea', oddsExact: 83.3, tier: 'high', expectedVerdict: 'accept' },
  { up: 'PTSD', cl: 'Obstructive sleep apnea', oddsExact: 82.1, tier: 'high', expectedVerdict: 'accept' },
  { up: 'Hypertension', cl: 'Ischemic heart disease', oddsExact: 81.8, tier: 'moderate', expectedVerdict: 'accept' },
  { up: 'GERD', cl: 'Obstructive sleep apnea', oddsExact: 81.2, tier: 'high', expectedVerdict: 'accept' },
  { up: 'Diabetes type 2', cl: 'Peripheral neuropathy', oddsExact: 78.9, tier: 'high', expectedVerdict: 'accept' },
  { up: 'Hearing loss', cl: 'Tinnitus', oddsExact: 78.8, tier: 'high', expectedVerdict: 'accept' },
  { up: 'Tinnitus', cl: 'Obstructive sleep apnea', oddsExact: 76.7, tier: 'high', expectedVerdict: 'accept' },
  // Moderate tier (still accept)
  { up: 'Lumbar / back', cl: 'Acquired psychiatric (unspecified)', oddsExact: 80, tier: 'moderate', expectedVerdict: 'accept' },
  { up: 'Obesity', cl: 'Hypertension', oddsExact: 75, tier: 'moderate', expectedVerdict: 'accept' },
  { up: 'Ankle', cl: 'Lumbar / back', oddsExact: 73.3, tier: 'high', expectedVerdict: 'accept' },
  { up: 'Diabetes type 2', cl: 'Hypertension', oddsExact: 71.8, tier: 'moderate', expectedVerdict: 'accept' },
  { up: 'Hypertension', cl: 'Stroke / CVA', oddsExact: 70, tier: 'moderate', expectedVerdict: 'accept' },
  // Caution band (50-70)
  { up: 'Lumbar / back', cl: 'Radiculopathy', oddsExact: 69.1, tier: 'high', expectedVerdict: 'caution' },
  { up: 'Knee', cl: 'Hip', oddsExact: 69.1, tier: 'high', expectedVerdict: 'caution' },
  { up: 'TBI', cl: 'Obstructive sleep apnea', oddsExact: 66.7, tier: 'moderate', expectedVerdict: 'caution' },
  { up: 'PTSD', cl: 'Hypertension', oddsExact: 66.7, tier: 'high', expectedVerdict: 'caution' },
  { up: 'Tinnitus', cl: 'Vertigo / Meniere', oddsExact: 64.3, tier: 'high', expectedVerdict: 'caution' },
  { up: 'MDD / Depression', cl: 'Hypertension', oddsExact: 63.6, tier: 'moderate', expectedVerdict: 'caution' },
  { up: 'Lumbar / back', cl: 'Knee', oddsExact: 60.5, tier: 'high', expectedVerdict: 'caution' },
  { up: 'Lumbar / back', cl: 'Cervical / neck', oddsExact: 59.5, tier: 'high', expectedVerdict: 'caution' },
  { up: 'Ischemic heart disease', cl: 'Obstructive sleep apnea', oddsExact: 57.1, tier: 'moderate', expectedVerdict: 'caution' },
  { up: 'Hypertension', cl: 'Diabetes type 2', oddsExact: 53.1, tier: 'moderate', expectedVerdict: 'caution' },
  // Low tier with high odds — engine should NOT auto-accept (caution due to thin data)
  { up: 'Hip', cl: 'Obstructive sleep apnea', oddsExact: 88.9, tier: 'low', expectedVerdict: 'caution' },
  { up: 'Cervical / neck', cl: 'MDD / Depression', oddsExact: 76.9, tier: 'low', expectedVerdict: 'caution' },
  { up: 'PTSD', cl: 'Diabetes type 2', oddsExact: 71.4, tier: 'low', expectedVerdict: 'caution' },
  { up: 'PTSD', cl: 'Tinnitus', oddsExact: 70, tier: 'low', expectedVerdict: 'caution' },
  // Low tier mid-band (caution by either rule)
  { up: 'PTSD', cl: 'COPD', oddsExact: 58.3, tier: 'low', expectedVerdict: 'caution' },
  // Reject (<50, curated fallback pairs)
  { up: 'PTSD', cl: 'Knee', oddsExact: 33.3, tier: 'moderate', expectedVerdict: 'reject' },
  { up: 'Hip', cl: 'Knee', oddsExact: 33.3, tier: 'high', expectedVerdict: 'reject' },
  { up: 'Lumbar / back', cl: 'Peripheral neuropathy', oddsExact: 45.5, tier: 'high', expectedVerdict: 'reject' },
];
...
const phrasingVariants: readonly { up: string; cl: string; expected: ExpectedShape }[] = [
  { up: 'ptsd', cl: 'sleep apnea', expected: { verdict: 'accept', oddsPctExact: 82.1, bvaMatched: true } },
  { up: 'POST-TRAUMATIC STRESS DISORDER', cl: 'OSA', expected: { verdict: 'accept', oddsPctExact: 82.1, bvaMatched: true } },
  { up: '  PTSD  ', cl: '  Obstructive sleep apnea  ', expected: { verdict: 'accept', oddsPctExact: 82.1, bvaMatched: true } },
  { up: 'Post traumatic stress', cl: 'Sleep apnea', expected: { verdict: 'accept', oddsPctExact: 82.1, bvaMatched: true } },
  { up: 'Hypertension', cl: 'Ischemic Heart Disease', expected: { verdict: 'accept', oddsPctExact: 81.8, bvaMatched: true } },
  { up: 'HTN', cl: 'ischemic heart disease', expected: { verdict: 'accept', oddsPctExact: 81.8, bvaMatched: true } },
  { up: 'High blood pressure', cl: 'IHD', expected: { verdict: 'accept', oddsPctExact: 81.8, bvaMatched: true } },
  { up: 'diabetes', cl: 'peripheral neuropathy', expected: { verdict: 'accept', oddsPctExact: 78.9, bvaMatched: true } },
  { up: 'dm2', cl: 'peripheral neuropathy', expected: { verdict: 'accept', oddsPctExact: 78.9, bvaMatched: true } },
  { up: 'type 2 diabetes', cl: 'PN', expected: { bvaMatched: false, verdict: 'caution' } },
  { up: 'low back', cl: 'radiculopathy', expected: { verdict: 'caution', oddsPctExact: 69.1, bvaMatched: true } },
  { up: 'lumbar', cl: 'radiculopathy', expected: { verdict: 'caution', oddsPctExact: 69.1, bvaMatched: true } },
  { up: 'lumbar spine', cl: 'radiculopathy', expected: { verdict: 'caution', oddsPctExact: 69.1, bvaMatched: true } },
];
...
// Recomputed 2026-06-07 against the curated atlas. Every expectedOdds/expectedVerdict is the engine's
// actual output. Pairs dropped from the curated atlas (e.g. PTSD->Wrist/Hip/Asthma/Shoulder, Hip->
// Cervical) were removed from coverage; their threshold bands are covered by surviving curated pairs.
const bucketC_pairs: readonly CoveragePair[] = [
  { up: 'PTSD', cl: 'Obstructive sleep apnea', expectedOdds: 82.1, expectedVerdict: 'accept' },
  { up: 'Knee', cl: 'Lumbar / back', expectedOdds: 71.4, expectedVerdict: 'accept' },
  { up: 'PTSD', cl: 'Erectile dysfunction', expectedOdds: 100, expectedVerdict: 'accept' },
  { up: 'PTSD', cl: 'GERD', expectedOdds: 94.1, expectedVerdict: 'accept' },
  { up: 'Knee', cl: 'Obstructive sleep apnea', expectedOdds: 84.6, expectedVerdict: 'accept' },
  { up: 'MDD / Depression', cl: 'Obstructive sleep apnea', expectedOdds: 88, expectedVerdict: 'accept' },
  { up: 'Sinusitis / rhinitis', cl: 'Obstructive sleep apnea', expectedOdds: 86.8, expectedVerdict: 'accept' },
  { up: 'Hearing loss', cl: 'Tinnitus', expectedOdds: 78.8, expectedVerdict: 'accept' },
  { up: 'Knee', cl: 'MDD / Depression', expectedOdds: 83.3, expectedVerdict: 'accept' },
  { up: 'Obesity', cl: 'Obstructive sleep apnea', expectedOdds: 88, expectedVerdict: 'accept' },
  { up: 'Cervical / neck', cl: 'Obstructive sleep apnea', expectedOdds: 85.7, expectedVerdict: 'accept' },
  { up: 'PTSD', cl: 'Migraines / headaches', expectedOdds: 93.9, expectedVerdict: 'accept' },
  { up: 'Ankle', cl: 'Knee', expectedOdds: 72, expectedVerdict: 'accept' },
  { up: 'Lumbar / back', cl: 'Obstructive sleep apnea', expectedOdds: 83.3, expectedVerdict: 'accept' },
  { up: 'Lumbar / back', cl: 'MDD / Depression', expectedOdds: 81.2, expectedVerdict: 'accept' },
  { up: 'Ankle', cl: 'Lumbar / back', expectedOdds: 73.3, expectedVerdict: 'accept' },
  { up: 'Diabetes type 2', cl: 'Peripheral neuropathy', expectedOdds: 78.9, expectedVerdict: 'accept' },
  { up: 'Tinnitus', cl: 'Migraines / headaches', expectedOdds: 96.9, expectedVerdict: 'accept' },
  { up: 'GERD', cl: 'Obstructive sleep apnea', expectedOdds: 81.2, expectedVerdict: 'accept' },
  { up: 'Obstructive sleep apnea', cl: 'Hypertension', expectedOdds: 80, expectedVerdict: 'accept' },
  { up: 'Obstructive sleep apnea', cl: 'Diabetes type 2', expectedOdds: 82.4, expectedVerdict: 'accept' },
  { up: 'Hypertension', cl: 'Stroke / CVA', expectedOdds: 70, expectedVerdict: 'accept' },
  { up: 'Plantar fasciitis / foot', cl: 'Lumbar / back', expectedOdds: 90.3, expectedVerdict: 'accept' },
  { up: 'Lumbar / back', cl: 'Acquired psychiatric (unspecified)', expectedOdds: 80, expectedVerdict: 'accept' },
  { up: 'Plantar fasciitis / foot', cl: 'Knee', expectedOdds: 84.2, expectedVerdict: 'accept' },
  { up: 'Knee', cl: 'Hip', expectedOdds: 69.1, expectedVerdict: 'caution' },
  { up: 'MDD / Depression', cl: 'Migraines / headaches', expectedOdds: 93.3, expectedVerdict: 'accept' },
  { up: 'TBI', cl: 'Obstructive sleep apnea', expectedOdds: 66.7, expectedVerdict: 'caution' },
  { up: 'Obesity', cl: 'PTSD', expectedOdds: 90.9, expectedVerdict: 'accept' },
  { up: 'PTSD', cl: 'MDD / Depression', expectedOdds: 72.7, expectedVerdict: 'accept' },
  { up: 'Hypertension', cl: 'Ischemic heart disease', expectedOdds: 81.8, expectedVerdict: 'accept' },
  { up: 'Hypertension', cl: 'Obstructive sleep apnea', expectedOdds: 71.4, expectedVerdict: 'accept' },
  { up: 'Diabetes type 2', cl: 'Hypertension', expectedOdds: 71.8, expectedVerdict: 'accept' },
  { up: 'Asthma', cl: 'Obstructive sleep apnea', expectedOdds: 81.5, expectedVerdict: 'accept' },
  { up: 'PTSD', cl: 'Diabetes type 2', expectedOdds: 71.4, expectedVerdict: 'caution' },
  { up: 'PTSD', cl: 'Ischemic heart disease', expectedOdds: 71.4, expectedVerdict: 'caution' },
  { up: 'PTSD', cl: 'Tinnitus', expectedOdds: 70, expectedVerdict: 'caution' },
  { up: 'PTSD', cl: 'Peripheral neuropathy', expectedOdds: 55.6, expectedVerdict: 'caution' },
  { up: 'Lumbar / back', cl: 'Knee', expectedOdds: 60.5, expectedVerdict: 'caution' },
  { up: 'PTSD', cl: 'Knee', expectedOdds: 33.3, expectedVerdict: 'reject' },
  { up: 'Hip', cl: 'Knee', expectedOdds: 33.3, expectedVerdict: 'reject' },
  { up: 'Lumbar / back', cl: 'Peripheral neuropathy', expectedOdds: 45.5, expectedVerdict: 'reject' },
  { up: 'Knee', cl: 'Cervical / neck', expectedOdds: 35.1, expectedVerdict: 'reject' },
  { up: 'Diabetes type 2', cl: 'Obstructive sleep apnea', expectedOdds: 46.7, expectedVerdict: 'reject' },
  { up: 'Tinnitus', cl: 'Vertigo / Meniere', expectedOdds: 64.3, expectedVerdict: 'caution' },
  { up: 'Ischemic heart disease', cl: 'Obstructive sleep apnea', expectedOdds: 57.1, expectedVerdict: 'caution' },
  { up: 'MDD / Depression', cl: 'Hypertension', expectedOdds: 63.6, expectedVerdict: 'caution' },
  { up: 'Lumbar / back', cl: 'Radiculopathy', expectedOdds: 69.1, expectedVerdict: 'caution' },
  { up: 'Cervical / neck', cl: 'Radiculopathy', expectedOdds: 70, expectedVerdict: 'accept' },
];
...
for (const v of caseVariants) {
  bucketE.push({
    ...
    expected: { verdict: 'accept', oddsPctExact: 82.1, bvaMatched: true, hardGateTriggered: false },
  });
}
...
bucketE.push({
  ...
  expected: { verdict: 'accept', oddsPctExact: 82.1, bvaMatched: true },
});
