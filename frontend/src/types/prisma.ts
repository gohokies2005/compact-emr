...
export interface Document extends VersionedRecord { readonly id: string; readonly caseId: string; readonly filename: string; readonly sizeBytes: string; readonly contentType: string; readonly docTag?: string; readonly pageCount?: number | null; readonly s3Key: string; readonly uploadedAt: string; readonly uploadedBy: string; }
